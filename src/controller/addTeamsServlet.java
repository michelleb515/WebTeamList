...
/**
 * Servlet implementation class addTeamsServlet
 */
@WebServlet("/addTeamsServlet")
public class addTeamsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Team Colors = " + teamColors);
		
		ListTeamsHelper lth = new ListTeamsHelper(); 
		ListTeams toAdd = new ListTeams(teamName, teamColors);
		lth.insertTeams(toAdd);
